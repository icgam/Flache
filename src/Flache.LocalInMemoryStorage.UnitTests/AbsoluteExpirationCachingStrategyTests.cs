...
{
    public class AbsoluteExpirationCachingStrategyTests
    {
        public AbsoluteExpirationCachingStrategyTests()
        {
            _timeProviderMock = Substitute.For<ITimeProvider>();
            _sut = new AbsoluteExpirationCachingStrategy(_timeProviderMock,
                new CacheStrategyOptions(_cacheExpiresAfter),
                Substitute.For<ILogger>());
        }

        private readonly AbsoluteExpirationCachingStrategy _sut;
        ...
        [Fact]
        public void GivenCache_WhenCacheIsPresentForBothKeysButExpiredForFirst_ThenReturnInValidCacheForFirstAndValidForSecond()
        {
            // Arrange
            _timeProviderMock.Now.Returns(new DateTime(2017, 01, 01, 12, 00, 00));
            _sut.CacheSet(FirstKey);
        ...
        [Fact]
        public void GivenCache_WhenCacheIsPresentForFirstKeyButRequestedForSecondKey_ThenReturnInValidCache()
        {
            // Arrange
            _timeProviderMock.Now.Returns(new DateTime(2017, 01, 01, 12, 00, 00));
            _sut.CacheSet(FirstKey);
