...
{
    public sealed class AbsoluteExpirationCachingStrategy : ICachingStrategy
    {
        ...
        public AbsoluteExpirationCachingStrategy(ITimeProvider timeProvider, CacheStrategyOptions options, ILogger log)
        {
